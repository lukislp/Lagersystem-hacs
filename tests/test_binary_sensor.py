...
def test_storage_critical_alert_on_when_value_at_threshold_and_state_critical() -> None:
    ...
    entity = LagerSystemStorageCriticalAlert(
        _make_coordinator(payload), _make_entry(), Mock()
    )
...
def test_storage_critical_alert_on_when_state_critical_but_value_below_threshold() -> (
    None
):
...
def test_storage_critical_alert_on_when_value_above_threshold_and_state_absent() -> (
    None
):
...
def test_storage_critical_alert_extra_state_attributes_injects_utilization_percent() -> (
    None
):
...
def test_high_activity_alert_on_when_value_above_threshold() -> None:
    ...
    entity = LagerSystemHighActivityAlert(
        _make_coordinator(payload), _make_entry(), Mock()
    )
